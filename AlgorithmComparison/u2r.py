...
def run_DBSCAN():
    ...
    helper.save("dbscan-u2r", fractions, number_of_positives, total_number, auc_roc, average_precisions, precisions,
                recalls,
...
if __name__ == '__main__':
    X = pd.read_csv('datasets/u2r_fixed2.csv')
    y = pd.read_csv('datasets/u2r_labels.csv').squeeze()
